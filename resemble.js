...
//TODO: try to substitute normal arrays with TypedArrays  
...
_this['resemble'] = function( fileData ){
	...
	function analyseImages(img1, img2, width, height){
		...
		var data1 = img1.data,
			data2 = img2.data,
			pixelBuffer1 = new ArrayBuffer(img1.data.length),
			imgPixels1 = new Uint32Array(pixelBuffer1),
			pixelBuffer2 = new ArrayBuffer(img2.data.length),
			imgPixels2 = new Uint32Array(pixelBuffer2),
			skip,
			imgd = new PNG({
				width: img1.width,
				height: img1.height,
		...
		// added name to callback function for debugging
		loop(height, width, function walkPixels(verticalPos, horizontalPos){
			...
			var offset = (verticalPos*width + horizontalPos) * 4,
				pixel1 = getPixelInfo(data1, offset, 1),
				pixel2 = getPixelInfo(data2, offset, 2);
